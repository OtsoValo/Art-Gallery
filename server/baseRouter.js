...
// 单张画作
baseRouter.get('/view/painting', (req, res) => {
	const id = req.query.id;
...
// 缩略图使用
baseRouter.get('/view/thumbnailList', (req, res) => {
...
// 所有艺术家
baseRouter.get('/view/artists', (req, res) => {
	const idImAry = [];
...
// 某画作所有信息
baseRouter.get('/view/paintingInfo', (req, res) => {
	const id = req.query.id;
...
// 某艺术家所有信息
baseRouter.get('/view/artistInfo', (req, res) => {
	const id = req.query.id;
